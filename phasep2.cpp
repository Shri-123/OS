...
void EXECUTE()
{
    while (true)
    {
        ...
        if (((IR[0] == 'G' || IR[0] == 'g') && (IR[1] == 'D' || IR[1] == 'd')) || ((IR[0] == 'S' || IR[0] == 's') && (IR[1] == 'R' || IR[1] == 'r')) )
            P.TTC += 2;
        else
            P.TTC += 1;
        ...
        if (((IR[0] == 'L' || IR[0] == 'l') && (IR[1] == 'R' || IR[1] == 'r')) )
        {
            int ra = ADDRESSMAP(add);
            if (ra == -1)
            {
        ...
        else if (((IR[0] == 'S' || IR[0] == 's') && (IR[1] == 'R' || IR[1] == 'r')) )
        {
            int ra = ADDRESSMAP(add);
        ...
        else if (((IR[0] == 'C' || IR[0] == 'c') && (IR[1] == 'R' || IR[1] == 'r')) )
        {
            int flag = 0;
        ...
        else if (((IR[0] == 'B' || IR[0] == 'b') && (IR[1] == 'T' || IR[1] == 't')) )
        {
            if (C == true)
                IC = add;
        }

        else if (((IR[0] == 'G' || IR[0] == 'g') && (IR[1] == 'D' || IR[1] == 'd')) )
        {
            SI = 1;
            MOS();
        }

        else if (((IR[0] == 'P' || IR[0] == 'p') && (IR[1] == 'D' || IR[1] == 'd')) )
        {
            SI = 2;
            MOS();
        }

        else if (IR[0] == 'H' || IR[0] == 'h')
        {
            SI = 3;
            MOS();
...
int main()
{
    ...
    inFile.open("E:\\VIT\\THIRD YEAR(TY)\\Phase1\\InputFile.txt", ios::in);
    outFile.open("E:\\VIT\\THIRD YEAR(TY)\\Phase1\\OutputFile.txt", ios::out);
